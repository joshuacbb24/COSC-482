...
class UI():
    ...
    def processEvents(self, event):
        if event.type == KEYDOWN:
            ...
            self.ge.box.changeVertex(0, self.ge.ScreenBounds[0], self.ge.ScreenBounds[1])
            self.ge.box.changeVertex(1, self.ge.ScreenBounds[1], self.ge.ScreenBounds[1])
            self.ge.box.changeVertex(2, self.ge.ScreenBounds[1], self.ge.ScreenBounds[2])
            self.ge.box.changeVertex(3, self.ge.ScreenBounds[0], self.ge.ScreenBounds[2])
