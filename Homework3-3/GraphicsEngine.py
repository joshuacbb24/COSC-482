...
from Box import *
from Axes2D import *
from RightEye import *
from RightPupil import *
from LeftEye import *
from LeftPupil import *
from Polygon import *
...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        try:
            ...
            self.constantShaderProgram = shader.loadShadersFromFile("PassThroughVert.glsl", "PassThroughFrag.glsl")
        ...
        glUseProgram(self.constantShaderProgram)
        self.c = False
        self.cProjLoc = glGetUniformLocation(self.constantShaderProgram, "Projection")
        self.setProjectionMatrix(pygame.display.get_surface().get_size())
        ...
        self.ScreenBounds = [-1, 1, -1, 1]

        self.atts = RAttributes()
        self.eyeAtts.append(self.atts)
        self.circ = Polygon(self.atts)
        self.eyes.append(self.circ)

        self.atts = LAttributes()
        self.eyeAtts.append(self.atts)
        self.circ = Polygon(self.atts)
        self.eyes.append(self.circ)

        self.atts = RPAttributes()
        self.pupilAtts.append(self.atts)
        self.circ = Polygon(self.atts)
        self.pupils.append(self.circ)

        self.atts = LPAttributes()
        self.pupilAtts.append(self.atts)
        self.circ = Polygon(self.atts)
        self.pupils.append(self.circ)
    ...
    def update(self):
        ...
        for i in range(2):
            ...
            b = self.pupilAtts[i]
            glUseProgram(self.shaderProgram)
            b.update(self.modelLoc, self.ScreenBounds, dt, self.mouseCoordinates)
            p.draw()
    ...
    def setOutlineMode(self):
        self.starAtts.setOutline()

    def setFillMode(self):
        self.starAtts.setFill()
    """
    ...
    def setProjectionMatrix(self, size):
        ...
        if self.c:
            ...
            glUniformMatrix4fv(self.cProjLoc, 1, GL_FALSE, glm.value_ptr(ProjectionMatrix))
