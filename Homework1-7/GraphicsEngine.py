...
class GraphicsEngine():
    ...
    def loadStarData(self, numpoints):
        ...
        for newpoint in range(numpoints):
            print(counter)
            self.data.append([1.00, 0.00, 0.00, oPoints[counter][0], oPoints[counter][1]])
            self.data.append([1.00, 1.00, 1.00, iPoints[counter][0], iPoints[counter][1]])
            self.data.append([1.00, 1.00, 1.00, 0, 0])
            if counter < numpoints - 1:
                self.data.append([1.00, 0.00, 0.00, oPoints[counter + 1][0], oPoints[counter + 1][1]])
                self.data.append([1.00, 1.00, 1.00, iPoints[counter][0], iPoints[counter][1]])
                self.data.append([1.00, 1.00, 1.00, 0, 0])
            else:
                self.data.append([1.00, 0.00, 0.00, oPoints[0][0], oPoints[0][1]])
                self.data.append([1.00, 1.00, 1.00, iPoints[counter][0], iPoints[counter][1]])
                self.data.append([1.00, 1.00, 1.00, 0, 0])
            counter += 1
