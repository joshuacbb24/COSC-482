...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        self.projviewLocPhong2 = glGetUniformLocation(self.LightingShader2, "ProjView")
        self.modelLocPhong2 = glGetUniformLocation(self.LightingShader2, "Model")
        self.normalMatrixLocPhong2 = glGetUniformLocation(self.LightingShader2, "NormalMatrix")
        GlobalAmbient2 = glm.vec4(0.2, 0.2, 0.2, 1)
        glUniform4fv(glGetUniformLocation(self.LightingShader2, "GlobalAmbient"),
                     1, glm.value_ptr(GlobalAmbient2))
        glUniform1i(glGetUniformLocation(self.LightingShader2, "numLights"), 3)

        glUseProgram(self.LightingShader3)
        self.projviewLocPhong3 = glGetUniformLocation(self.LightingShader3, "ProjView")
        self.modelLocPhong3 = glGetUniformLocation(self.LightingShader3, "Model")
        self.normalMatrixLocPhong3 = glGetUniformLocation(self.LightingShader3, "NormalMatrix")
        GlobalAmbient3 = glm.vec4(0.2, 0.2, 0.2, 1)
        glUniform4fv(glGetUniformLocation(self.LightingShader3, "GlobalAmbient"),
                     1, glm.value_ptr(GlobalAmbient3))
        glUniform1i(glGetUniformLocation(self.LightingShader3, "numLights"), 3)
    ...
    def LoadMatrices(self, model):
        ...
        glUniformMatrix4fv(self.modelLocPhong2, 1, GL_FALSE, glm.value_ptr(model))
        glUniformMatrix4fv(self.modelLocPhong3, 1, GL_FALSE, glm.value_ptr(model))
        NM = glm.inverse(glm.transpose(glm.mat3(model)))
        glUniformMatrix3fv(self.normalMatrixLocPhong, 1, GL_FALSE, glm.value_ptr(NM))
        glUniformMatrix3fv(self.normalMatrixLocPhong2, 1, GL_FALSE, glm.value_ptr(NM))
        glUniformMatrix3fv(self.normalMatrixLocPhong3, 1, GL_FALSE, glm.value_ptr(NM))
    ...
    def update(self):
        ...
        glUseProgram(self.LightingShader2)
        for i in range(3):
            self.lights[i].LoadLight(self.LightingShader2, "Lt[" + str(i) + "]")
        ...
        glUniform3fv(glGetUniformLocation(self.LightingShader2, "eye"), 1, glm.value_ptr(eye))

        glUseProgram(self.LightingShader3)
        for i in range(3):
            self.lights[i].LoadLight(self.LightingShader3, "Lt[" + str(i) + "]")
        ...
        glUniform3fv(glGetUniformLocation(self.LightingShader3, "eye"), 1, glm.value_ptr(eye))
    ...
    def setProjectionMatrix(self, size):
        ...
        glUseProgram(self.LightingShader2)
        glUniformMatrix4fv(self.projviewLocPhong2, 1, GL_FALSE, glm.value_ptr(PV))
        glUseProgram(self.LightingShader3)
        glUniformMatrix4fv(self.projviewLocPhong3, 1, GL_FALSE, glm.value_ptr(PV))
        glUseProgram(self.ConstColorShader)
