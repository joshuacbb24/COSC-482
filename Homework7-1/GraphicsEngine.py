...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        self.texID[0] = self.loadTexture("Images/HW007_Textures/Prob1_Textures/AE.png")
        self.texID[1] = self.loadTexture("Images/HW007_Textures/Prob1_Textures/AT.png")
        self.texID[2] = self.loadTexture("Images/HW007_Textures/Prob1_Textures/JV.png")
        self.texID[3] = self.loadTexture("Images/HW007_Textures/Prob1_Textures/PE.png")
        self.texID[4] = self.loadTexture("Images/HW007_Textures/Prob1_Textures/RD.png")
        self.texID[5] = self.loadTexture("Images/HW007_Textures/Prob1_Textures/SK.png")
    ...
    def update(self):
        ...
        self.PictureCube.draw(self.textures)
