...
class Material():
    ...
    def BluePlastic(self):
        self.ambient = glm.vec4(0, 0, 0.6, 1)
        self.diffuse = glm.vec4(0.1, 0, 0.3, 1)
        self.specular = glm.vec4(0.3, 0.3, 0.5, 1)
        self.emission = glm.vec4(0, 0, 0, 1)
        self.shininess = 32
    ...
    def Silver(self):
        self.ambient = glm.vec4(0.10000, 0.10000, 0.10000, 1)
        self.diffuse = glm.vec4(0.22222, 0.22222, 0.22222, 1)
        self.specular = glm.vec4(0.333333, 0.333333, 0.333333, 1)
        self.emission = glm.vec4(0, 0, 0, 1)
        self.shininess = 5
    ...
    def Emerald(self):
        self.ambient = glm.vec4(0.01111, 0.01111, 0.01111, 0.55)
        self.diffuse = glm.vec4(0.12222, 0.35555, 0.12222, 0.55)
        self.specular = glm.vec4(.11111, 0.11111, .11111, 1)
        self.emission = glm.vec4(0, 0, 0, 1)
        self.shininess = 10
