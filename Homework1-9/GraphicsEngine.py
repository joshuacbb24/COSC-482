...
class GraphicsEngine():
    ...
    def loadStarData(self, numpoints):
        ...
        for newpoint in range(numpoints):
            print(counter)
            self.data.append([random.random(), random.random(), random.random(), oPoints[counter][0], oPoints[counter][1]])
            self.data.append([random.random(), random.random(), random.random(), iPoints[counter][0], iPoints[counter][1]])
            self.data.append([1.00, 1.00, 1.00, 0, 0])
            if counter < numpoints - 1:
                self.data.append([random.random(), random.random(), random.random(), oPoints[counter + 1][0], oPoints[counter + 1][1]])
                self.data.append([random.random(), random.random(), random.random(), iPoints[counter][0], iPoints[counter][1]])
                self.data.append([1.00, 1.00, 1.00, 0, 0])
            else:
                self.data.append([random.random(), random.random(), random.random(), oPoints[0][0], oPoints[0][1]])
                self.data.append([random.random(), random.random(), random.random(), iPoints[counter][0], iPoints[counter][1]])
                self.data.append([1.00, 1.00, 1.00, 0, 0])
            counter += 1
    ...
    def incrementPoints(self, inc):
        ...
        if (2 < self.points < 100) or (self.points == 2 and inc == 1) or \
            ...
            for newpoint in range(self.points):
                print(counter)
                self.data.append(
                    [random.random(), random.random(), random.random(), oPoints[counter][0], oPoints[counter][1]])
                self.data.append(
                    [random.random(), random.random(), random.random(), iPoints[counter][0], iPoints[counter][1]])
                self.data.append([1.00, 1.00, 1.00, 0, 0])
                if counter < self.points - 1:
                    self.data.append([random.random(), random.random(), random.random(), oPoints[counter + 1][0],
                                      oPoints[counter + 1][1]])
                    self.data.append(
                        [random.random(), random.random(), random.random(), iPoints[counter][0], iPoints[counter][1]])
                    self.data.append([1.00, 1.00, 1.00, 0, 0])
